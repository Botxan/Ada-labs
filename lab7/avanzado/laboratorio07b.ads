package Laboratorio07b is
   ...
   --post: resultado es el complejo C en forma trinhgonometrica
   ...
   --post: El resultado es true si las filas de P cumplen los requisitos de las filas una vez añadida la ficha F en el espacio cuya esquina superior izquierda es la fila F y la columna C (y 2 siguientes).
