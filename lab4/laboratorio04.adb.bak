...
package body Laboratorio04 is
   ...
   begin
      ...
      while numero /= -1 and numero = secuencia_correcta and secuencia_correcta /= 1 loop
         --Secuencia Collatz
      ...
      if numero = secuencia_correcta then -- como el ultimo numero es -1, sumarle +2 para que sea 1
         Resultado := True;
      end if;
